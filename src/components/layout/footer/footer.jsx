...
const Footer = () => {
  return (
    <footer className="/50 grid h-full w-full grid-cols-2 grid-rows-4 md:w-3/4 md:grid-cols-9">
      ...
      <div className="col-span-1 col-start-2 row-span-full row-start-1 flex flex-col items-center justify-center md:col-span-5 md:col-start-3 md:row-span-full md:row-start-1">
        <div className="grid grid-cols-2 grid-rows-3 gap-y-5">
          <p>Telephon</p>
          <p>+961 00 000 000</p>
          <p>Fax</p>
          <p>+961 00 000 000</p>
